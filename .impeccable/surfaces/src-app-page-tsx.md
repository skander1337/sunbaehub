...
STORY: The visitor reads in one line that Sunbae books an hour with a verified senior for credits, believes it because the three rules (price follows reviews, 50% refund, fraud flags) are stated plainly and the screen is the real product, then takes one of two equal actions: 선배 찾기 or 선배 되기.
